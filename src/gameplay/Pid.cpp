...
void Pid::RenderIdle() {
    ...
    DrawText("NO", pidMenu.x + (pidMenu.width/2), pidMenu.y + (pidMenu.height/2) - 50, 40, WHITE);
    DrawText("PROCESS", pidMenu.x + (pidMenu.width/2), pidMenu.y + (pidMenu.height/2), 40, WHITE);
    DrawText("ACTIVE", pidMenu.x + (pidMenu.width/2), pidMenu.y + (pidMenu.height/2) + 50, 40, WHITE);
}
...
void Pid::Render() {
    ...
    if(!isCounting) {
        ...
        DrawRectangleRec(pidMenu, BLACK);
        DrawText("PID", pidMenu.x + (pidMenu.width/2), (pidMenu.height/2) - 50, 40, WHITE);
        DrawText("PROCESS", pidMenu.x + (pidMenu.width/2), (pidMenu.height/2), 40, WHITE);
        DrawText("MANAGER", pidMenu.x + (pidMenu.width/2), (pidMenu.height/2) + 50, 40, WHITE);
        DrawRectangleLinesEx(pidMenu, 2, primaryColor);
    }
}
