...
void HandleSetAudio(){
   ...
   master_volume = DrawSlider(volume_master_slider, 0.0, 1.0, master_volume);
   ...
   music_volume = DrawSlider(volume_music_slider, 0.0, 1.0, music_volume);
   ...
   sfx_volume = DrawSlider(volume_sfx_slider, 0.0, 1.0, sfx_volume);
