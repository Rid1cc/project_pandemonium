...
void RotatingRectangleGame::Update() {
    ...
    Vector2 popupPos = {rect.x, rect.y}; // Assume popupX and popupY are accessible
    rectInner = {popupPos.x + rect.width / 4, popupPos.y + rect.height / 4, rect.width / 2, rect.height / 2};
